...
#define DYNA_AXIS_1_SRL					1		// return level 0=none, 1=only for read command, 2= always
#define DYNA_AXIS_1_RDT					250		// return delay time = 2µs * value -> 500µs
...
#define DYNA_AXIS_1_CW_C_SLOPE			32		// compliance slope (clock wise) - default value
#define DYNA_AXIS_1_CCW_C_SLOPE			32		// compliance slope (counter clock wise) - default value
#define DYNA_AXIS_1_CW_C_MARGIN			0		// compliance margin (clock wise) - default value
#define DYNA_AXIS_1_CCW_C_MARGIN		0		// compliance margin (counter clock wise) - default value
...
//typedef int16_t(*funcPtr)(uint8_t id, int16_t val);
