...
int DynamixelClass::setHighVoltageLimit(unsigned char ID, unsigned char UVoltage)
{
...
int DynamixelClass::setLowVoltageLimit(unsigned char ID, unsigned char DVoltage)
{
